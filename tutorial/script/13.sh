...
# 2. Your lab bench: the mlir-pdll tool (13-defining-patterns-with-pdll.md)
...
# 3.1 The smallest possible pattern (13-defining-patterns-with-pdll.md)
...
# 3.2 Includes: how PDLL knows your ops (13-defining-patterns-with-pdll.md)
...
# 3.6 Step: grow a real pattern (13-defining-patterns-with-pdll.md)
...
# 3.8 Rewrites: the full menu (13-defining-patterns-with-pdll.md)
...
# 5. The pass: parsing patterns at runtime (13-defining-patterns-with-pdll.md)
...
# 6. Under the hood: watching a pattern become bytecode (13-defining-patterns-with-pdll.md)
...
# 7. Build integration and running it (13-defining-patterns-with-pdll.md)
